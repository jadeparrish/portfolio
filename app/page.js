...
const caseStudies = [
  {
    ...
    cta: 'Coming soon',
    href: null,
    tint: 'bg-[#EDEAE4] dark:bg-[#EDEAE4]/10',
  },
  {
    num: '02',
    ...
    cta: 'View case study',
    href: '#',
    tint: 'bg-[#E3E6E1] dark:bg-[#E3E6E1]/10',
  },
  {
    num: '03',
    ...
    cta: 'View case study',
    href: '#',
    tint: 'bg-[#E7E2DC] dark:bg-[#E7E2DC]/10',
  },
  {
    num: '04',
    ...
    cta: 'View case study',
    href: '#',
    tint: 'bg-[#DDE3E6] dark:bg-[#DDE3E6]/10',
  },
  {
    num: '05',
    ...
    cta: 'View case study',
    href: '#',
    tint: 'bg-[#E9E4DE] dark:bg-[#E9E4DE]/10',
  },
  {
    num: '06',
    ...
    cta: 'View case study',
    href: '#',
    tint: 'bg-[#E4E1E8] dark:bg-[#E4E1E8]/10',
  },
];
...
function SectionLabel({ children }) {
  return (
    <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-neutral-400 dark:text-neutral-500 mb-10 lg:mb-12">
      {children}
    </p>
  );
}
...
export default function PortfolioHomepage() {
  return (
    <div className="min-h-screen bg-[#F9F8F6] dark:bg-[#171514] text-[#1C1C1C] dark:text-[#F0EDE8] font-sans antialiased selection:bg-neutral-200 dark:selection:bg-neutral-700 transition-colors">
      {/* Top Navigation */}
      <header className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-8 sm:py-10 lg:py-12 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-baseline">
        <div className="space-y-1">
          <h1 className="font-semibold tracking-[0.18em] text-xs uppercase text-neutral-900 dark:text-neutral-100">
            JADE PARRISH
          </h1>
          <p className="text-neutral-500 dark:text-neutral-400 normal-case text-xs tracking-normal font-normal">
            Human-centred service &amp; systems designer
          </p>
        </div>
        <div className="flex items-center gap-6 sm:gap-8">
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-2 sm:gap-x-8 lg:gap-x-10 text-xs tracking-[0.15em] uppercase text-neutral-600 dark:text-neutral-400">
          ...
          <button
            ...
            className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full border border-neutral-300 dark:border-neutral-700 text-neutral-600 dark:text-neutral-400 hover:border-[#A47864] hover:text-[#A47864] transition-colors"
          >
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        {/* Hero */}
        <section className="py-16 sm:py-20 lg:py-28 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-10 lg:gap-20 items-center border-b border-neutral-200/80 dark:border-neutral-800/80">
          <div className="md:col-span-6 space-y-8">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-normal leading-[1.12] tracking-tight text-neutral-900 dark:text-neutral-100">
              Better systems <br />
              create better <span className="italic text-[#A47864]">lives</span>.
            </h2>
            <div className="space-y-5 text-neutral-600 dark:text-neutral-400 text-base sm:text-lg leading-relaxed max-w-lg font-normal">
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-2 text-xs text-neutral-500 dark:text-neutral-500 tracking-wide">
            ...
            <div className="pt-2">
              <a
                href="#work"
                className="inline-flex items-center gap-2.5 text-xs uppercase tracking-[0.18em] font-medium text-neutral-900 dark:text-neutral-100 hover:text-[#A47864] hover:translate-x-0.5 transition-all"
              >
          ...
          <div className="md:col-span-6">
            <div className="aspect-[4/3] w-full max-h-[320px] md:max-h-none rounded-sm border border-dashed border-neutral-300 dark:border-neutral-700 bg-white/60 dark:bg-white/5 flex flex-col items-center justify-center gap-3 text-center px-8">
              <ImageIcon className="w-6 h-6 text-neutral-300 dark:text-neutral-600" strokeWidth={1.5} />
              <p className="text-xs uppercase tracking-[0.15em] text-neutral-400 dark:text-neutral-500 font-medium">
                Hero illustration: coming soon
              </p>
              <p className="text-xs text-neutral-400 dark:text-neutral-500 max-w-[220px]">
        ...
        {/* About */}
        <section id="about" className="py-20 lg:py-28 border-b border-neutral-200/80 dark:border-neutral-800/80">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-10 lg:gap-16 items-start">
            <div className="md:col-span-4">
              <div className="aspect-[4/5] max-h-[460px] md:max-h-none w-full max-w-xs md:max-w-none mx-auto bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-sm overflow-hidden">
                <img
                  src={jadePhoto.src}
                  alt="Jade Parrish"
            ...
            <div className="md:col-span-8 space-y-8">
              <div>
                <p className="text-[11px] uppercase tracking-[0.2em] font-medium text-neutral-400 dark:text-neutral-500 mb-3">
                  About
                </p>
                <h3 className="text-2xl sm:text-3xl font-serif text-neutral-900 dark:text-neutral-100 leading-snug">
                  I&rsquo;m a human-centred service and systems designer.
                </h3>
              </div>

              <div className="space-y-5 text-neutral-600 dark:text-neutral-400 text-base leading-relaxed max-w-2xl font-normal">
                <p>
                ...
                <blockquote className="border-l-2 border-neutral-300 dark:border-neutral-700 pl-4 py-1 italic font-serif text-neutral-800 dark:text-neutral-300 text-lg">
              ...
              <div className="pt-8 border-t border-neutral-200/80 dark:border-neutral-800/80">
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-xs sm:text-sm text-neutral-800 dark:text-neutral-300 font-mono tracking-wider">
                  <span>Service Design</span>
                  <span className="w-1 h-1 rounded-full bg-neutral-400 dark:bg-neutral-600 translate-y-[3px]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14">
            {whatIDo.map((item) => (
              <div key={item.title} className="space-y-4">
                <item.icon className="w-5 h-5 text-neutral-400 dark:text-neutral-500" strokeWidth={1.5} />
                <h3 className="font-serif text-xl font-normal text-neutral-900 dark:text-neutral-100">
                  {item.title}
                </h3>
        ...
        {/* Selected Work */}
        <section id="work" className="py-16 lg:py-24 border-b border-neutral-200/80 dark:border-neutral-800/80">
            ...
            {caseStudies.map((item) => (
              ...
              >
                <div className="md:col-span-1 lg:col-span-3">
                  <div
                    className={`aspect-[4/3] max-h-[240px] md:max-h-none rounded-sm border border-neutral-200/80 dark:border-neutral-800/80 ${item.tint} flex flex-col items-center justify-center gap-1`}
                  >
                    <span className="font-serif text-2xl text-neutral-400 dark:text-neutral-600">{item.num}</span>
                ...
                <div className="md:col-span-1 lg:col-span-9 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
                  <div className="space-y-2 lg:max-w-lg">
                    <p className="text-[10px] uppercase tracking-[0.15em] text-neutral-400 dark:text-neutral-500 font-medium">
                      {item.tag}
                    </p>
                    <h3 className="font-serif text-xl sm:text-2xl text-neutral-900 dark:text-neutral-100 leading-snug">
                      {item.title}
                    </h3>
                    <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                      {item.description}
                  ...
                  <div className="shrink-0 lg:pt-1 lg:text-right">
                    {item.href ? (
                      <a
                        href={item.href}
                        className="inline-flex items-center gap-1.5 text-xs text-neutral-900 dark:text-neutral-100 font-medium tracking-wider uppercase hover:text-[#A47864] group-hover:translate-x-1 transition-all"
                      >
                        {item.cta} <ArrowRight className="w-3.5 h-3.5 text-neutral-400 dark:text-neutral-600 group-hover:text-[#A47864] transition-colors" />
                      </a>
                    ) : (
                      <span className="inline-flex items-center gap-1.5 text-xs text-neutral-400 dark:text-neutral-600 font-medium tracking-wider uppercase">
                        {item.cta}
                      </span>
                    )}
                  </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-10">
            {whoIWorkWith.map((item) => (
              <div key={item.title} className="space-y-3">
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-500 leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* What I'm Noticing */}
        <section id="thinking" className="py-16 lg:py-24 border-b border-neutral-200/80 dark:border-neutral-800/80">
          <SectionLabel>What I&rsquo;m Noticing</SectionLabel>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            {thoughts.map((article) => (
              <div
                key={article.title}
                className="group cursor-pointer border-t border-neutral-200/60 dark:border-neutral-800/60 pt-5 space-y-3"
              >
                <article.icon className="w-5 h-5 text-neutral-300 dark:text-neutral-600" strokeWidth={1.5} />
                <h4 className="font-serif text-lg text-neutral-900 dark:text-neutral-100 leading-snug group-hover:underline underline-offset-4 decoration-neutral-300 dark:decoration-neutral-600">
                  {article.title}
                </h4>
                <p className="text-[11px] font-mono text-neutral-400 dark:text-neutral-600">{article.readTime}</p>
              </div>
            ))}
          </div>
          <div className="mt-12">
            <a
              href="#"
              className="inline-flex items-center gap-1.5 text-xs uppercase tracking-[0.15em] font-medium text-neutral-800 dark:text-neutral-300 hover:text-[#A47864] transition-colors"
            >
        ...
        <section id="contact" className="py-24 lg:py-32 text-center space-y-8">
          <div className="inline-block px-4 py-1.5 bg-[#A47864]/10 dark:bg-[#A47864]/15 border border-[#A47864]/30 dark:border-[#A47864]/40 text-[#A47864] rounded-full text-xs font-mono tracking-wide">
            Open to Part-Time Roles &amp; Fractional Contracts (2&ndash;3 days/week)
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-neutral-900 dark:text-neutral-100 tracking-tight">
            Let&rsquo;s improve something together.
          </h2>
          <div className="pt-2">
            <a
              href="mailto:hello@jadeparrish.me"
              className="text-lg sm:text-2xl font-serif text-neutral-900 dark:text-neutral-100 underline underline-offset-8 decoration-neutral-300 dark:decoration-neutral-700 hover:decoration-[#A47864] transition-colors"
            >
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-200/80 dark:border-neutral-800/80 py-10 text-xs text-neutral-500 dark:text-neutral-500 font-normal">
